...
```{r go_enrich, warning=FALSE, echo=FALSE}
...
```{r go_enrich_stat, warning=FALSE, echo=FALSE}
# 1. Load example datasets
data(go_anno)
# head(go_anno)
...
```{r go_enrich_bar, warning=FALSE, echo=FALSE}
# 1. Load example datasets
data(go_anno)
# head(go_anno)
...
```{r go_enrich_dot, warning=FALSE, echo=FALSE}
# 1. Load example datasets
data(go_anno)
# head(go_anno)
...
```{r go_enrich_tree, warning=FALSE, echo=FALSE}
# 1. Load example datasets
data(go_anno)
# head(go_anno)
...
```{r go_enrich_net, warning=FALSE, echo=FALSE}
# 1. Load example datasets
data(go_anno)
# head(go_anno)
