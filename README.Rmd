...
-   [Benben Miao: https://github.com/benben-miao](https://github.com/benben-miao)

-   [Wei Dong: https://github.com/dongwei1220](https://github.com/dongwei1220)
...
```{r gene_cluster_trend, warning=FALSE}
# 1. Load example datasets
...
```{r gene_rank_plot, warning=FALSE}
# 1. Load example datasets
data(deg_data)
...
```{r heatmap_cluster, warning=FALSE}
# 1. Load example datasets
data(gene_exp)
