...
#' library(TOmicsVis)
#'
#' # 2. Use example dataset gene_cluster
#' data(gene_cluster)
#' head(gene_cluster)
#'
#' # 3. Default parameters
#' gene_cluster_trend(gene_cluster)
#'
#' # 4. Set palette = "RdBu"
#' gene_cluster_trend(gene_cluster, palette = "RdBu")
#'
#' # 5. Set cluster_num = 6
#' gene_cluster_trend(gene_cluster, cluster_num = 6, palette = "Spectral")
#'
#' # 6. Set thres = 0.1
#' gene_cluster_trend(gene_cluster, thres = 0.1, palette = "RdYlGn")
#'
