...
#### 3.1.1 quantile_plot
**Input Data:** Dataframe: Trait measurement of samples in multiple groups (1st-col: Values, 2nd-col: Groups).
...
#### 3.1.2 corr_heatmap
**Input Data:** Dataframe: gene expression dataframe (1st-col: Transcripts or Genes, 2nd-col~: Samples).
...
#### 3.1.3 pca_plot
**Input Data1:** Dataframe: gene expression dataframe (1st-col: Transcripts or Genes, 2nd-col~: Samples).
